...
<blockquote class="layui-elem-quote">修改教师信息直接在表格中编辑即可！</blockquote>
...
<button type="button" class="layui-btn layui-btn-normal" onclick="addoneTeacher()">
...
<div id="addTeacher" style="display: none">
    <div class="form-horizontal" style="margin-top: 25px">
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input class="form-control"  type="text" placeholder="请输入工号!" id="userId"></input>
...
<script>
    ...
    //下载
    function downAll() {
        window.location.href = '${ctx}/exportTeacherAllList';
    }
    //校验表单数据
